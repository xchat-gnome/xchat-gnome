...
const GdkColor *color_schemes[] = {
        colors_black_on_white, colors_white_on_black, custom_colors, theme_colors,
};
...
const GdkColor *palette_schemes[] = {
        palette_black_on_white, palette_white_on_black, custom_palette, optimized_palette,
};

static void optimize_palette(GdkColor background)
{
        optimized_palette[0] = optimized_palette[16] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_WHITE);
        optimized_palette[1] = optimized_palette[17] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_BLACK);
        optimized_palette[2] = optimized_palette[18] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_BLUE);
        optimized_palette[3] = optimized_palette[19] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_GREEN);
        optimized_palette[4] = optimized_palette[20] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_BROWN);
        optimized_palette[5] = optimized_palette[21] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_RED);
        optimized_palette[6] = optimized_palette[22] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_PURPLE);
        optimized_palette[7] = optimized_palette[23] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_ORANGE);
        optimized_palette[8] = optimized_palette[24] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_YELLOW);
        optimized_palette[9] = optimized_palette[25] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_LIGHT_GREEN);
        optimized_palette[10] = optimized_palette[26] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_AQUA);
        optimized_palette[11] = optimized_palette[27] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_LIGHT_BLUE);
        optimized_palette[12] = optimized_palette[28] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_BLUE);
        optimized_palette[13] = optimized_palette[29] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_MAGENTA);
        optimized_palette[14] = optimized_palette[30] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_GREY);
        optimized_palette[15] = optimized_palette[31] =
            contrast_render_foreground_color(background, CONTRAST_COLOR_LIGHT_GREY);
}

static void extract_theme_colors(void)
{
        GtkWidget *w;
        GtkStyle *style;
...
void palette_save(void)
{
        ...
        if (f != -1) {
                for (i = 0; i < 32; i++) {
                        snprintf(prefname, sizeof(prefname), "color_%d", i);
                        cfg_put_color(f,
                                      custom_palette[i].red,
                                      custom_palette[i].green,
                                      custom_palette[i].blue,
                                      prefname);
                }

                cfg_put_color(f,
                              custom_colors[0].red,
                              custom_colors[0].green,
                              custom_colors[0].blue,
                              "color_258");
                cfg_put_color(f,
                              custom_colors[1].red,
                              custom_colors[1].green,
                              custom_colors[1].blue,
                              "color_259");
                cfg_put_color(f,
                              custom_colors[2].red,
                              custom_colors[2].green,
                              custom_colors[2].blue,
                              "color_256");
                cfg_put_color(f,
                              custom_colors[3].red,
                              custom_colors[3].green,
                              custom_colors[3].blue,
                              "color_257");
                cfg_put_color(f,
                              custom_colors[4].red,
                              custom_colors[4].green,
                              custom_colors[4].blue,
                              "color_264");
                cfg_put_color(f,
                              custom_colors[5].red,
                              custom_colors[5].green,
                              custom_colors[5].blue,
                              "color_261");
                cfg_put_color(f,
                              custom_colors[6].red,
                              custom_colors[6].green,
                              custom_colors[6].blue,
                              "color_262");
                cfg_put_color(f,
                              custom_colors[7].red,
                              custom_colors[7].green,
                              custom_colors[7].blue,
                              "color_263");
                cfg_put_color(f,
                              custom_colors[8].red,
                              custom_colors[8].green,
                              custom_colors[8].blue,
                              "color_260");
