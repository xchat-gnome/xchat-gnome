...
static int tree_find_insertion_pos(tree *t, void *key, int *done)
{
        int c, u, l, idx;
...
static void tree_insert_at_pos(tree *t, void *key, int pos)
{
        int post_bytes;
...
static void *mybsearch(const void *key, void **array, size_t nmemb,
...
static void tree_remove_at_pos(tree *t, int pos)
{
        int post_bytes;
