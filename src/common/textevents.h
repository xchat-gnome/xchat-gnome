...
const struct text_event te[] =
    {
      ...
      { "Add Notify", pevt_generic_nick_help, 1, N_("-%C10-%C11-%O$t$1 added to notify list.") },

      { "Ban List", pevt_banlist_help, 4, N_("-%C10-%C11-%O$t$1 Banlist: %C3$4 %C4$2 %C5$3%O") },
      ...
      { "Change Nick", pevt_changenick_help, 2, N_("-%C10-%C11-%O$t$1 is now known as $2") },

      { "Channel Action", pevt_chanaction_help, 2, N_("%C13*%O$t$1 $2%O") },

      { "Channel Action Hilight", pevt_chanaction_help, 2, N_("%C13*%O$t%C8%B$1%B%O $2%O") },

      { "Channel Ban", pevt_chanban_help, 2, N_("-%C10-%C11-%O$t$1 sets ban on $2") },

      { "Channel Creation", pevt_chandate_help, 2, N_("-%C10-%C11-%O$tChannel $1 created on $2") },
      ...
      { "Channel Exempt", pevt_chanexempt_help, 2, N_("-%C10-%C11-%O$t$1 sets exempt on $2") },
      ...
      { "Channel INVITE", pevt_chaninvite_help, 2, N_("-%C10-%C11-%O$t$1 sets invite on $2") },

      { "Channel List", pevt_generic_none_help, 0, N_("%UChannel          Users   Topic%O") },

      { "Channel Message", pevt_chanmsg_help, 4, N_("%C2<%O$1%C2>%O$t$2%O") },
      ...
      { "Channel Modes", pevt_chanmodes_help, 2, N_("-%C10-%C11-%O$tChannel $1 modes: $2") },

      { "Channel Msg Hilight", pevt_chanmsg_help, 4, N_("%C2<%C8%B$1%B%C2>%O$t$2%O") },

      { "Channel Notice", pevt_channotice_help, 3, N_("%C12-%C13$1/$2%C12-%O$t$3%O") },
      ...
      { "Channel UnBan", pevt_chanunban_help, 2, N_("-%C10-%C11-%O$t$1 removes ban on $2") },

      { "Channel Voice", pevt_chanvoice_help, 2, N_("-%C10-%C11-%O$t$1 gives voice to $2") },

      { "Connected", pevt_generic_none_help, 0, N_("-%C10-%C11-%O$tConnected. Now logging in..") },
      ...
      { "CTCP Generic", pevt_ctcpgen_help, 2, N_("-%C10-%C11-%O$tReceived a CTCP $1 from $2") },
      ...
      { "CTCP Send", pevt_ctcpsend_help, 2, N_("%C3>%O$1%C3<%O$tCTCP $2%O") },

      { "CTCP Sound", pevt_ctcpsnd_help, 2, N_("-%C10-%C11-%O$tReceived a CTCP Sound $1 from $2") },
      ...
      { "DCC Malformed", pevt_malformed_help, 2, N_("-%C10-%C11-%O$tReceived a malformed DCC "
                                                    "request from "
                                                    "%C11$1%O.%010-%C10-%C11-%O$tContents of "
                                                    "packet: $2") },

      { "DCC Offer", pevt_dccoffer_help, 3, N_("-%C10-%C11-%O$tOffering %C11$1 %Cto %C11$2%O") },

      { "DCC Offer Not Valid", pevt_generic_none_help, 0, N_("-%C10-%C11-%O$tNo such DCC offer.") },
      ...
      { "Disconnected", pevt_discon_help, 1, N_("-%C10-%C11-%O$tDisconnected ($1).") },

      { "Found IP", pevt_foundip_help, 1, N_("-%C10-%C11-%O$tFound your IP: [$1]") },

      { "Generic Message", pevt_genmsg_help, 2, N_("$1$t$2") },

      { "Ignore Add", pevt_ignoreaddremove_help, 1, N_("%O%C11$1%O added to ignore list.") },

      { "Ignore Changed", pevt_ignoreaddremove_help, 1, N_("Ignore on %C11$1%O changed.") },
      ...
      { "Ignore Remove", pevt_ignoreaddremove_help, 1, N_("%O%C11$1%O removed from ignore list.") },

      { "Ignorelist Empty", pevt_generic_none_help, 0, N_("  Ignore list is empty.") },
      ...
      { "Join", pevt_join_help, 3, N_("-%C10-%C11>%O$t%B$1%B %C14(%C10$3%C14)%C has joined $2") },
      ...
      { "Kick", pevt_kick_help, 4, N_("<%C10-%C11-%O$t$1 has kicked $2 from $3 ($4%O)") },

      { "Killed", pevt_kill_help, 2, N_("-%C10-%C11-%O$tYou have been killed by $1 ($2%O)") },

      { "Message Send", pevt_ctcpsend_help, 2, N_("%C3>%O$1%C3<%O$t$2%O") },

      { "Motd", pevt_servertext_help, 1, N_("-%C10-%C11-%O$t$1%O") },

      { "MOTD Skipped", pevt_generic_none_help, 0, N_("-%C10-%C11-%O$tMOTD Skipped.") },
      ...
      { "No DCC", pevt_generic_none_help, 0, N_("-%C10-%C11-%O$tNo such DCC.") },
      ...
      { "Notice", pevt_notice_help, 2, N_("%C12-%C13$1%C12-%O$t$2%O") },

      { "Notice Send", pevt_ctcpsend_help, 2, N_("%C3>%O$1%C3<%O$t$2%O") },

      { "Notify Empty", pevt_generic_none_help, 0, N_("-%C10-%C11-%O$tNotify list is empty.") },
      ...
      { "Notify Number", pevt_notifynumber_help, 1, N_("-%C10-%C11-%O$t$1 users in notify list.") },
      ...
      { "Part", pevt_part_help, 3, N_("<%C10-%C11-%O$t$1 %C14(%O$2%C14)%C has left $3") },
      ...
      { "Private Message", pevt_privmsg_help, 3, N_("%C12*%C13$1%C12*$t%O$2%O") },

      { "Private Message to Dialog", pevt_privmsg_help, 3, N_("%C2<%O$1%C2>%O$t$2%O") },
      ...
      { "Quit", pevt_quit_help, 3, N_("<%C10-%C11-%O$t$1 has quit %C14(%O$2%O%C14)%O") },
      ...
      { "Receive Wallops", pevt_privmsg_help, 2, N_("%C12-%C13$1/Wallops%C12-%O$t$2%O") },
      ...
      { "Server Connected", pevt_generic_none_help, 0, N_("-%C10-%C11-%O$tConnected.") },

      { "Server Error", pevt_servererror_help, 1, N_("-%C10-%C11-%O$t$1%O") },

      { "Server Lookup", pevt_serverlookup_help, 1, N_("-%C10-%C11-%O$tLooking up %C11$1%C..") },

      { "Server Notice", pevt_servertext_help, 2, N_("-%C10-%C11-%O$t$1%O") },

      { "Server Text", pevt_servertext_help, 2, N_("-%C10-%C11-%O$t$1%O") },
      ...
      { "Topic", pevt_topic_help, 2, N_("-%C10-%C11-%O$tTopic for %C11$1%C is %C11$2%O") },
      ...
      { "Users On Channel", pevt_usersonchan_help, 2, N_("-%C10-%C11-%O$t%C11Users on $1:%C $2") },

      { "WhoIs Authenticated", pevt_whoisauth_help, 3, N_("%C22*%O$t%C28[%O$1%C28] %O$2%C27 $3") },
      ...
      { "WhoIs Channel/Oper Line", pevt_whois2_help, 2, N_("-%C10-%C11-%O$t%C12[%O$1%C12]%C $2") },
      ...
      { "WhoIs Identified", pevt_whoisid_help, 2, N_("-%C10-%C11-%O$t%C12[%O$1%C12] %C$2") },
      ...
      { "WhoIs Server Line", pevt_whois3_help, 2, N_("-%C10-%C11-%O$t%C12[%O$1%C12]%O $2") },

      { "WhoIs Special", pevt_whoisid_help, 3, N_("%C22*%O$t%C28[%O$1%C28]%O $2") },

      { "You Join", pevt_ukick_help, 4, N_("-%C10-%C11>%O$t%BYou%B are now talking on %C11$2%O") },
      ...
      { "You Part", pevt_part_help, 3, N_("-%C10-%C11-%O$tYou have left channel $3") },
      ...
      { "Your Action", pevt_chanaction_help, 131, "%C18*$t$1%O $2" },
      ...
      { "Your Message", pevt_chanmsg_help, 4, N_("%C6<%O$1%C6>%O$t$2%O") },
