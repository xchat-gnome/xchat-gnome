...
void send_channel_modes(session *sess, char *tbuf, char *word[], int wpos, int end, char sign,
                        char mode, int modes_per_line)
{
...
static int mode_timeout_cb(session *sess)
{
        if (is_session(sess)) {
...
static void handle_single_mode(mode_run *mr, char sign, char mode, char *nick, char *chan,
                               char *arg, int quiet, int is_324)
{
        session *sess;
        server *serv = mr->serv;
        char outbuf[4];
...
void handle_mode(server *serv, char *word[], char *word_eol[], char *nick, int numeric_324)
{
        ...
        while (*modes) {
                ...
                default:
                        ...
                        handle_single_mode(&mr,
                                           sign,
                                           *modes,
                                           nick,
                                           chan,
                                           argstr,
                                           numeric_324 || prefs.raw_modes,
                                           numeric_324);
                }
