...
static gboolean get_reg_str(const char *sub, const char *name, char *out, DWORD len)
{
        HKEY hKey;
        DWORD t;
...
static char *convert_with_fallback(const char *str, const char *fallback)
{
        char *utf;
