...
static void test_server_cb(DBusGProxy *proxy, char *word[], char *word_eol[], guint hook_id,
                           guint context_id, gpointer user_data)
{
...
static void test_command_cb(DBusGProxy *proxy, char *word[], char *word_eol[], guint hook_id,
                            guint context_id, gpointer user_data)
{
        GError *error = NULL;
...
int main(int argc, char **argv)
{
        ...
        remote_object =
            dbus_g_proxy_new_for_name(connection, DBUS_SERVICE, path, DBUS_REMOTE_PLUGIN_INTERFACE);
        g_free(path);
